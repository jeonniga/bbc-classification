#dependencies
# https://github.com/Arghyadeep/Document-Classification-with-CNN/blob/master/CNN%20with%20word2vec%20embeddings.ipynb
...
import os
path = os.path.dirname(os.path.abspath(__file__))
raw_embedding = load_embedding(path + '\\embedding_word2vec.txt')
